...
- 시작: 2026-08-29T11:45:37.384Z
- 종료: 2026-08-29T11:53:21.065Z
...
- 최종 URL: http://localhost:3001/en/explore?category=festival&area=39
...
- 기대: 같은 장소의 영문 상세로 간다
- 판정: 페이지 평가 결과가 참이어야 하는데 false 다 _(rule)_
- 최종 URL: http://localhost:3001/en/explore
...
| ID | P | 절 | 메모 |
|---|---|---|---|
| TC-EXP-11 | P2 | 탐색 화면 — 필터 | QA 가 화면에서 직접 판정했다. |
| TC-WTH-03 | P0 | 날씨·미세먼지 | QA 가 화면에서 직접 판정했다. |
| TC-WTH-04 | P1 | 날씨·미세먼지 | QA 가 화면에서 직접 판정했다. |
